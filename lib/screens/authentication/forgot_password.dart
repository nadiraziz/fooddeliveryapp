              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text('Forgot password', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 34)),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(top: 10.0),
                    child: Text("Please enter OTP we’ve sent you on +9898534321 Edit", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 16,color: Color(0xFF506481))),
                  ),
                  Padding(
